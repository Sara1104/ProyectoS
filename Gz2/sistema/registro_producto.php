		...
		if (empty($_POST['proveedor']) ||empty($_POST['producto'])|| empty($_POST['precio']) || $_POST['precio'] <= 0 || empty($_POST['cantidad'] || $_POST['cantidad'] <= 0))
		{
            ...
            $query_insert = mysqli_query($conection,"INSERT INTO producto(descripcion,proveedor,precio,existencia,usuario_id,foto)
                ...
                if($query_insert){
					...
					$alert='<p class="msg_save">Producto grabado correctamente.</p>';
				}else{
					$alert='<p class="msg_error">Error al grabar el producto.</p>';
           }	    
		}
	  }
...
<body>
	...
	mysqli_close($conection);        
             ...
             <option value="<?php echo $proveedor['codproveedor']; ?>"><?php echo $proveedor['proveedor']; ?></option>
				...
				<input type="text" name="precio" id="precio" placeholder="Precio del Producto">  <!--Type text o number?--> 
				<label for="cantidad">Cantidad</label>
				<input type="number" name="cantidad" id="cantidad" placeholder="Cantidad del Producto" min="1">
            <div class="photo">
				...
				<button type="submit"class="btn_save"><i class="fas fa-save fa-lg"></i> Grabar Producto</button>
			</form>
		</div>
	</section>
